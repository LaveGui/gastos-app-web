...
const API_URL = 'https://script.google.com/macros/s/AKfycbxJHW9DTWeUBEgacgqK_r-lVIYAqIDjjyaiFLLo6rzwV4lNh-i2Ilm0FwGXTZKCYKaqCQ/exec';
...
async function renderGastosView() {
    ...
    if (searchInput) {
        searchInput.addEventListener('input', (e) => {
            ...
            if (currentGastosSearchTerm === '') {
                isDeepSearchActive = false;
                $('#lista-titulo').innerText = `Tus Gastos ${showFixedExpenses ? '' : '(Sin Fijos)'}`;
            }
